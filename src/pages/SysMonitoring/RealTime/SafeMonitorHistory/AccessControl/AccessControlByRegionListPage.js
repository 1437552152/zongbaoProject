/**
 * Created by skyinno on 2019/5/7.跟区域相关的门禁监管历史纪录
 */
import React, { PureComponent } from 'react';
import { connect } from 'dva';
import { Spin, Modal, Form, Input,Button,Icon,Upload,message,Select } from 'antd';
import StandTable from '../StandardTable';
import HistorySearchBar from '../HistorySearchBar/index';
import styles from './AccessControlListPage.less';
import { AccessControlByRegionListPageColumns } from '../ColumnsPlubic';
...
class AccessControlByRegionListPage extends PureComponent {
  state = { 
    selectPersons: [], 
    visible: false,
    visibleL:false,
...
onStatus = (id,listData) => {
  ...
  render() {
    ...
    const tableProps = {
      ...
      bordered: true,
      // columns,
      columns: AccessControlByRegionListPageColumns({ onDelete: this.onDelete,onDetail:this.onDetail,onStatus:this.onStatus,onPic:this.onPic,onPicStatus:this.onPicStatus,lookPic:this.lookPic }),
      data:{
        list:data,
        pagination: {
         total,
...
export default AccessControlByRegionListPage;
