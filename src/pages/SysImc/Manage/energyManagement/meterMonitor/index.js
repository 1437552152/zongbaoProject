...
const ElectricityList = `${Host}/api/EnergyManagement&type=Electricity`;
...
class energyMonitor extends Component {
    ...
    this.props.dispatch({
      ...
      callback: data => {
        if (data !== undefined) {
          ...
          message.error("获取电表监控信息失败，请刷新页面后重试！");
        }
      }
    });
  };
  ...
  oldData = list => {
    ...
    if (meterData === null) {
      sessionStorage.setItem("meterData", JSON.stringify(list));
    } else {
      sessionStorage.removeItem("meterData");
      sessionStorage.setItem("meterData", JSON.stringify(list));
    }
    router.push("meterHistory");
  };
          ...
          <div className={styles.monitor_right}>
            {/* <div className={styles.right_title}>
              ...
              <p className={styles.personCTitleTxt}>
                ...
                <span style={{ margin: "0 8px" }}>/</span>电表监控
              </p>
            </div> */}
            ...
            <Link to="wattCheck" className={styles.router_btn}>
  ...
  render() {
    ...
    return (
      <div className={styles.monitor_box}>
        <SiderContent
        ...
        <Spin spinning={this.props.dislogLoading}>
          ...
          >
            <Form>
              ...
              <Row span={24}>
                <FormItem {...formItemLayout} label="电表编号">
              ...
              <Row span={24}>
                <FormItem {...formItemLayout} label="电表卡号">
              ...
              <Row span={24}>
                <FormItem {...formItemLayout} label="电表创号">
